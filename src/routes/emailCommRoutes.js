...
/* ============================================================
   ...
   - Uses port 587 + STARTTLS (works on Render)
   - Forces IPv4 to avoid Render's IPv6 routing issues
   ============================================================ */
...
exports.testSmtp = async (req, res) => {
  try {
    ...
    res.json({ success: true, message: "Gmail SMTP connected successfully via port 587" });
  } catch (err) {
